...
function changeTheme() {
  ...
  if (selectedOption === 'dark') {
    ...
    if (localStorage.userSelectedTheme) {
      localStorage.removeItem('userSelectedTheme');
    };
    localStorage.setItem('userSelectedTheme', JSON.stringify(darkTheme));
    ...
    localStorage.setItem('userSelectedTheme', JSON.stringify(lightkTheme));
    ...
    localStorage.setItem('userSelectedTheme', JSON.stringify(dolphinTheme));
    ...
    localStorage.setItem('userSelectedTheme', JSON.stringify(seahawkTheme));
  } else {
    ...
    localStorage.setItem('userSelectedTheme', JSON.stringify(defaultTheme));
  };
}
